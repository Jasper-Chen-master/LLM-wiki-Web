import type { ProjectSnapshot, SearchResult, WikiEdge, WikiNode } from "../../shared/contracts.js";

export type ExportableKnowledge = Pick<ProjectSnapshot, "project" | "documents" | "nodes" | "edges" | "evidence"> | SearchResult;
